# AGENTS.md — SOMA v1 Agent Contract
...
- `soma context <project> [--watch]` — compact context summary; --watch regenerates AGENTS.md on change
...
- Config/state lives ONLY in `~/.soma/` (projects.toml). Never write inside watched repos
  except AGENTS.md when --watch explicitly targets a repo.
...
Start:
1. Read AGENTS.md + docs/SESSION_LOG.md (last entry) + CHECKLIST.md
